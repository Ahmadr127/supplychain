    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Edit Tipe Barang</h2>
                <a href="{{ route('item-types.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
            ...
            <form action="{{ route('item-types.update', $itemType) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $itemType->name) }}" required
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  placeholder="Deskripsi tipe">{{ old('description', $itemType->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $itemType->is_active) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <span class="ml-2 text-sm text-gray-700">Tipe Aktif</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-1"></i> Update Tipe
                    </button>
                </div>
            </form>
        </div>
