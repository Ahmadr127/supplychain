    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Edit Master Barang</h2>
        ...
        <div class="p-6">
            <form action="{{ route('master-items.update', $masterItem) }}" method="POST" id="masterItemForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $masterItem->name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code" value="{{ old('code', $masterItem->code) }}" required
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                      ...
                                      placeholder="Deskripsi barang">{{ old('description', $masterItem->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="item_type_id" name="item_type_id" required
                                ...
                                @foreach($itemTypes as $type)
                                    <option value="{{ $type->id }}" {{ old('item_type_id', $masterItem->item_type_id) == $type->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select id="item_category_id" name="item_category_id" required
                                ...
                                @foreach($itemCategories as $category)
                                    <option value="{{ $category->id }}" {{ old('item_category_id', $masterItem->item_category_id) == $category->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select id="commodity_id" name="commodity_id" required
                                ...
                                @foreach($commodities as $commodity)
                                    <option value="{{ $commodity->id }}" {{ old('commodity_id', $masterItem->commodity_id) == $commodity->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select id="unit_id" name="unit_id" required
                                ...
                                @foreach($units as $unit)
                                    <option value="{{ $unit->id }}" {{ old('unit_id', $masterItem->unit_id) == $unit->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="hna" name="hna" value="{{ old('hna', $masterItem->hna) }}" required step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="ppn_percentage" name="ppn_percentage" value="{{ old('ppn_percentage', $masterItem->ppn_percentage) }}" required step="0.01" min="0" max="100"
                                       ...
                                       placeholder="11.00" oninput="calculateTotal()">
                        ...
                        <div>
                            ...
                            <input type="number" id="stock" name="stock" value="{{ old('stock', $masterItem->stock) }}" min="0" readonly
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-600 cursor-not-allowed"
                                   placeholder="0">
                            <p class="mt-1 text-xs text-gray-500">Stok dapat diubah melalui menu manajemen stok terpisah</p>
                        </div>

                        <!-- Status -->
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $masterItem->is_active) ? 'checked' : '' }}
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    <a href="{{ route('master-items.show', $masterItem) }}" 
