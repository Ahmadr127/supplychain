    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Tambah Komoditas</h2>
            ...
            <form action="{{ route('commodities.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  placeholder="Deskripsi komoditas">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-1"></i> Simpan Komoditas
                    </button>
                </div>
            </form>
        </div>
